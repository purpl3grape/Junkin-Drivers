...
public class CustomInspectorBehavior : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showRunTimeVariables || vehicleBehavior.keepTabsOpen || vehicleBehavior.showRunTimeVariablesOnly)
        {
            ...
            vehicleBehavior.gravity_float = (float)EditorGUILayout.FloatField("Gravity", vehicleBehavior.gravity_float);
            vehicleBehavior.max_accel_modified = EditorGUILayout.FloatField("Maximum Target Speed", vehicleBehavior.max_accel_modified);
            vehicleBehavior.wheel_steer_float = EditorGUILayout.FloatField("Wheel Steer", vehicleBehavior.wheel_steer_float);
            vehicleBehavior.max_steer_modified = EditorGUILayout.FloatField("Maximum Target Vehicle Steering", vehicleBehavior.max_steer_modified);
